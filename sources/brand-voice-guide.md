...
| Attribute | Our Position | Not This |
|-----------|-------------|----------|
| Formality | Professional but approachable | Academic or stiff |
| Confidence | Assured and knowledgeable | Arrogant or hedging |
| Warmth | Friendly and helpful | Overly casual or cold |
| Complexity | Clear and accessible | Dumbed down or jargon-heavy |

### Personality Traits

- **Expert** — we know our subject deeply and share insights generously
- **Direct** — we get to the point without preamble or filler
